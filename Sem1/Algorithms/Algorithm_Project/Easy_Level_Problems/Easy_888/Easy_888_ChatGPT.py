...
class Solution:
    def fairCandySwap(self, aliceSizes: List[int], bobSizes: List[int]) -> List[int]:
        ...
        # The difference that needs to be compensated: Alice should receive this more
        diff = (sum_alice - sum_bob) // 2  # Alice gives 'a', Bob gives 'b', a - b = diff => b = a - diff
        ...
        return None  # Guaranteed to exist per problem statement
